    ...
    <header className="sticky top-0 z-50 bg-[#fbfbe2]/90 backdrop-blur-md border-b border-outline-variant/20">
        <div className="max-w-[1200px] mx-auto px-6 h-20 flex items-center justify-between gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-8 shrink-0">
                ...
                <Link to="/support" className="font-label-md text-sm text-on-surface hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary pb-1">Support</Link>
            </nav>
            ...
            <div className="flex items-center gap-4 shrink-0">
                ...
                {!isAdmin && (
                  <>
                    <Link to="/wishlist" className="hidden sm:flex w-10 h-10 items-center justify-center rounded-full hover:bg-surface-container text-on-surface transition-colors relative" aria-label="Wishlist">
                        <Heart className="w-5 h-5" />
                    </Link>
                    <Link to="/checkout" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-surface-container text-on-surface transition-colors relative" aria-label="Cart">
                        <ShoppingCart className="w-5 h-5" />
                        <span className="absolute 1 top-0 right-0 w-4 h-4 rounded-full bg-primary text-on-primary text-[9px] font-bold flex items-center justify-center border-2 border-background">0</span>
                    </Link>
                  </>
                )}
                ...
                {isAuthenticated ? (
                  <>
                    <Link to="/profile" className="hidden sm:flex w-10 h-10 items-center justify-center rounded-full hover:bg-surface-container text-on-surface transition-colors relative" aria-label="Profile">
                  ...
                  <>
                    <Link to="/auth" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-surface-container text-on-surface transition-colors" aria-label="Account">
                        <User className="w-5 h-5" />
                    </Link>
