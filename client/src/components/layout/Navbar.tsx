          ...
          <div className="max-w-[1200px] mx-auto px-6 h-20 flex items-center justify-between gap-8">
              ...
              <nav className="hidden lg:flex items-center gap-8 shrink-0">
                  ...
                  {isAuthenticated && !isAdmin && (
                    <>
                      <Link to="/dashboard" state={{ tab: 'orders' }} className="font-label-md text-sm text-on-surface hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary pb-1">Order History</Link>
                    </>
                  )}
              ...
              <div className="flex items-center gap-4 shrink-0">
                  ...
                  {isAuthenticated ? (
                    <>
                      ...
                      <button onClick={handleLogout} className="w-10 h-10 hidden sm:flex items-center justify-center rounded-full hover:bg-surface-container text-error transition-colors" aria-label="Logout">
