  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-surface border-t border-outline-variant/30 pb-safe z-50">
        <div className="flex justify-around items-center h-16">
            ...
            <Link to="/dashboard" className={`flex flex-col items-center justify-center w-full h-full ${path === '/dashboard' ? 'text-primary' : 'text-on-surface-variant'}`}>
                <div className={`w-16 h-8 rounded-full flex items-center justify-center mb-1 ${path === '/dashboard' ? 'bg-secondary-container' : ''}`}>
